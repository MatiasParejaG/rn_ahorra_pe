import { getMetaGrupalDetails } from '@/lib/appwrite';
    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="bg-white px-6 pt-4 pb-4 border-b border-gray-100">
        <View className="flex-row items-center justify-between">
          ...
          <Text className="text-xl font-bold text-gray-800">Detalle de Meta</Text>
          <View className="w-6" />
        </View>
      </View>
          ...
          <View className="bg-white rounded-2xl p-6 mb-6">
            ...
            <View className="flex-row justify-between items-center mb-4 pb-4 border-b border-gray-100">
              ...
              <View className="items-end">
                ...
                <Text className="text-lg font-bold text-gray-800">
                  {getCurrencySymbol()} {meta.estado ? meta.monto_objetivo.toFixed(2) : montoRestante.toFixed(2)}
                </Text>
              </View>
            </View>
          ...
          {topContribuidores.length > 0 && (
            <View className="bg-white rounded-2xl p-5 mb-6">
              <View className="flex-row items-center mb-4">
                <MaterialCommunityIcons name="trophy" size={24} color="#FE8C00" />
                <Text className="text-lg font-bold text-gray-800 ml-2">
                  Principales Aportadores
                </Text>
              </View>

              {topContribuidores.slice(0, 5).map((contrib: any, index: number) => {
                const contribution = (contrib.totalAportado / meta.monto_actual) * 100;
                    ...
                    <View className="flex-row items-center flex-1">
                      ...
                      <View className="flex-1">
                        ...
                        <Text className="text-xs text-gray-500">
                          {contrib.cantidadAportes} aporte{contrib.cantidadAportes !== 1 ? 's' : ''} • {contribution.toFixed(1)}%
                        </Text>
                      </View>
                    </View>
